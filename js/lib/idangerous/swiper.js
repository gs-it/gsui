...
(function () {
        ...
        s.initEvents = function (detach) {
            ...
            if (s.browser.ie) {
                ...
                if (params.simulateTouch && !s.device.ios && !s.device.android) {
                    ...
                    $(touchEventsTarget)[actionDom]('mousedown', s.onTouchStart, false);
                    $(target)[actionDom]('mousemove', s.onTouchMove, moveCapture);
                    $(target)[actionDom]('mouseup', s.onTouchEnd, false);
                }
            }


            //window[action]('resize', s.onResize);
            $(window)[actionDom]('resize', s.onResize);
            ...
            if (s.params.preventClicks || s.params.preventClicksPropagation) $(touchEventsTarget)[actionDom]('click', s.preventClicks, true);
        };
    ...
    Swiper.prototype = {
        ...
        ====================================================*/
        support: {
            addEvent:function($target, evt, func, capture){
                if(window.addEventListener || document.addEventListener){
                    $target.addEventListener(evt, func, capture);
                }else{
                    $target.attachEvent('on'+ evt, func);
                }
            },
            removeEvent:function($target, evt, func, capture){
                if(window.removeEventListener || document.removeEventListener){
                    $target.removeEventListener(evt, func, capture);
                }else{
                ...
                for (i = 0; i < this.length; i++) {
                    if (typeof targetSelector === 'function' || targetSelector === false) {
                        ...
                        for (j = 0; j < events.length; j++) {
                            support.addEvent(this[i], events[j], listener, capture);
                        }
                    }
                    else {
                        //Live events
                        for (j = 0; j < events.length; j++) {
                            ...
                            support.addEvent(this[i], events[j], handleLiveEvent, capture);
                        }
                    }
                }
                ...
                for (var i = 0; i < events.length; i++) {
                    for (var j = 0; j < this.length; j++) {
                        if (typeof targetSelector === 'function' || targetSelector === false) {
                            ...
                            support.removeEvent(this[j], events[i], listener, capture);
                        }
                        else {
                            // Live event
                            if (this[j].dom7LiveListeners) {
                                for (var k = 0; k < this[j].dom7LiveListeners.length; k++) {
                                    if (this[j].dom7LiveListeners[k].listener === listener) {
                                        ...
                                        support.removeEvent(this[j], events[i], this[j].dom7LiveListeners[k].liveListener, capture);
                                    }
                                }
                            }
                        }
